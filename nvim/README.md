...
| [neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) | `neo-tree.lua` | ファイルツリーエクスプローラ（v3.x） | `<leader>e` トグル, `<leader>E` フォーカス, ツリー内: `<cr>` 開く, `a` 追加, `d` 削除, `r` リネーム, `?` ヘルプ |
